...
public class StateFight extends BasicGameState implements InputListener {
    ...
    public void enter(GameContainer gameContainer, StateBasedGame stateBasedGame) throws SlickException {
        p1_control = new KeyboardEntityController(left, Input.KEY_A, Input.KEY_D, Input.KEY_W, Input.KEY_LCONTROL);
        p2_control = new KeyboardEntityController(right, Input.KEY_LEFT, Input.KEY_RIGHT, Input.KEY_UP, Input.KEY_RCONTROL);
